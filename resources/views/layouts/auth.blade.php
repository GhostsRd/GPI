                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto offset-11">
                        ...
                        <li class="nav-item dropdown shadow-sm rounded-5 btn-sm">
                          <div class="row navigate" id="navbarDropdown" class="row nav-link dropdown-toggle fw-bold" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            <div class="col-lg-4">
                              <img src="{{asset('/images/avtar_1.png')}}" class="rounded-5" width="40" height="40" alt="">
