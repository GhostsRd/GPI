<div class="ticket-dashboard">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-0">{{ $selectedMoniteur->nom }}</p>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="mt-1">
                                    @php
                                        ...
                                        $classe = $statutClasses[$selectedMoniteur->statut] ?? 'bg-secondary text-white';
                                    @endphp
                                    <span class="badge {{ $classe }} px-3 py-2">
                                        <i class="fas {{ $this->getIconeStatut($selectedMoniteur->statut) }} me-1"></i>
                                        {{ $selectedMoniteur->statut }}
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <strong class="text-primary">Entité:</strong>
                                <p class="mb-0">{{ $selectedMoniteur->entite ?? 'N/A' }}</p>
                            </div>
                            <div class="mb-3">
                                <strong class="text-primary">Lieu:</strong>
                                <p class="mb-0">{{ $selectedMoniteur->lieu ?? 'N/A' }}</p>
                            </div>
                        </div>
                        
                        <div class="col-md-6">
                            <h6 class="text-muted border-bottom pb-2 mb-3">Spécifications techniques</h6>
                            <div class="mb-3">
                                <strong class="text-primary">Fabricant:</strong>
                                <p class="mb-0">{{ $selectedMoniteur->fabricant ?? 'N/A' }}</p>
                            </div>
                            <div class="mb-3">
                                <strong class="text-primary">Modèle:</strong>
                                <p class="mb-0">{{ $selectedMoniteur->modele ?? 'N/A' }}</p>
                            </div>
                            <div class="mb-3">
                                <strong class="text-primary">Type:</strong>
                                <p class="mb-0">
                                    @if($selectedMoniteur->type)
                                        <span class="badge bg-light text-dark border">{{ $selectedMoniteur->type }}</span>
                                    @else
                                        N/A
                                    @endif
                                </p>
                            ...
                            <div class="mb-3">
                                <strong class="text-primary">Numéro de série:</strong>
                                <p class="mb-0 font-monospace">{{ $selectedMoniteur->numero_serie ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <h6 class="text-muted border-bottom pb-2 mb-3">Assignations</h6>
                            <div class="mb-3">
                                <strong class="text-primary">Utilisateur:</strong>
                                <div class="mt-1">
                                    @if($selectedMoniteur->utilisateur)
                                        <span class="badge bg-primary text-white">
                                            <i class="fas fa-user me-1"></i>
                                            {{ $selectedMoniteur->utilisateur->name }}
                                        </span>
                                    @else
                            ...
                            <div class="mb-3">
                                <strong class="text-primary">Usager:</strong>
                                <div class="mt-1">
                                    @if($selectedMoniteur->usager)
                                        <span class="badge bg-secondary text-white">
                                            <i class="fas fa-users me-1"></i>
                                            {{ $selectedMoniteur->usager->name }}
                                        </span>
                                    @else
                        ...
                        <div class="col-md-6">
                            <h6 class="text-muted border-bottom pb-2 mb-3">Dates</h6>
                            <div class="mb-3">
                                <strong class="text-primary">Créé le:</strong>
                                <p class="mb-0">
                                    <i class="far fa-calendar me-1 text-muted"></i>
                                    {{ $selectedMoniteur->created_at->format('d/m/Y H:i') }}
                                </p>
                            </div>
                            <div class="mb-3">
                                <strong class="text-primary">Modifié le:</strong>
                                <p class="mb-0">
                                    <i class="far fa-calendar-check me-1 text-muted"></i>
                                    {{ $selectedMoniteur->updated_at->format('d/m/Y H:i') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <h6 class="text-muted border-bottom pb-2 mb-3">Commentaires</h6>
                            <div class="card bg-light border-0">
                                <div class="card-body">
                                    <p class="mb-0">{{ $selectedMoniteur->commentaires }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Ajouter ces modals à votre vue existante -->
