        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    @if($isBulkDelete)
                        <p class="fs-5 mb-1">Êtes-vous sûr de vouloir supprimer les <strong>{{ count($selectedImprimantes) }}</strong> imprimantes sélectionnées ?</p>
                    @else
                        <p class="fs-5 mb-1">Êtes-vous sûr de vouloir supprimer l'imprimante <strong>{{ $selectedImprimanteName }}</strong> ?</p>
                    @endif
