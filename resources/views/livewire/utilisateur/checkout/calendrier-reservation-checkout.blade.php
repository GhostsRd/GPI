<div class="container-fluid row " style="margin-top: 5% ;scrollbar-width: none; -ms-overflow-style: none;"
    ...
    <div class="col-lg-2 offset-1 bg-white py-1 px-0 ">
        ...
        <ul style="list-style: none " class="px-2 py-2 ">
                    ...
                    <li style="cursor: pointer" class="bg-light bg-gradient py-2 " wire:click="openReservationModal('ordinateur',{{ $reserverId }})" 
                    data-bs-toggle="modal"
                    data-bs-target="#centeredModalreservation"><svg width="20"
                ...
                @if ($lastEvent)
                    Type de materiel :<label
                        class="text-muted text-center py-1 text-capitalize"><small>{{ $lastEvent->equipement_type }}
                            {{ $lastEvent->ordinateur->nom }}</small></label>
                    <br>
                    Utilisateur :
                    ...
                    <a href="#" style="--bs-bg-opacity: .5;"
                        ...
                        <div class="d-flex w-100 mt-2 justify-content-between">
                            <p class="mb-1 text-capitalize">
                                <small class="text-muted"> {{ $event->ordinateur->os_version }}</small>
                            </p>
