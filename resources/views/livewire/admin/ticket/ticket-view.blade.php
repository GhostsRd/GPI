      ...
      <div class="col-lg-9  mb-md-2 mb-sm-2">
        <div class="container shadow-sm bg-white mt-0 pt-3 p-4 rounded-3">
          ...
          <div class="container-fluid mt-3">
            <div class="row ">
              <div class="col-lg-3"><button id="prevBtn" class="btn btn-sm btn-success border-0">Reculer</button>  <button id="nextBtn" class="btn btn-sm btn-outline-success border border-success">next</button></div>
