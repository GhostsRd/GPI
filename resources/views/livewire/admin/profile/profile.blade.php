<div>
    ...
    <div class="container shadow-sm rounded-2 bg-white">
        <div >
            ...
            <div class="col-lg-7 ">
                <h2 class="fw-bold mt-5"> {{ Auth::guard('utilisateur')->user()->nom  }}</h2>
                <p class="border-start border-warning border-3  "><small class="mx-2">  Administrateur Systeme</small> </p>
            </div>
        </div>
        ...
        <div class="row  mt-4 mb-4">
            <div class="col-lg-2 text-center  col-3"> 
                ...
                <div class="border bg-success-light shadow-sm py-1 rounded-2">
